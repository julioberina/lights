...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$item', '$o', '$bg', '$state', '$lambda', '$set_bg', '$actions', '$run']);
  ...
  (function($base, $super, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      return self.$item("bg", $hash2(["default"], {"default": ""}))
    })($nesting[0], Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ovto'), 'State'), $nesting);
    (function($base, $super, $parent_nesting) {
      function $Actions(){};
      var self = $Actions = $klass($base, $super, 'Actions', $Actions);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Actions_set_bg_1;

      return (Opal.defn(self, '$set_bg', TMP_Actions_set_bg_1 = function $$set_bg($kwargs) {
        var self = this, value;
        ...
        return $hash2(["bg"], {"bg": value})
      }, TMP_Actions_set_bg_1.$$arity = 1), nil) && 'set_bg'
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_MainComponent_render_19;

      return (Opal.defn(self, '$render', TMP_MainComponent_render_19 = function $$render() {
        var TMP_2, self = this;

        return $send(self, 'o', ["div", $hash2(["align"], {"align": "center"})], (TMP_2 = function(){var self = TMP_2.$$s || this, TMP_3, TMP_4, TMP_9;

        
          $send(self, 'o', ["h1", $hash2(["style"], {"style": $hash2(["fontFamily"], {"fontFamily": "'Arial', sans-serif"})})], (TMP_3 = function(){var self = TMP_3.$$s || this;

          return self.$o("text", "Light Switch")}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3));
          $send(self, 'o', ["table"], (TMP_4 = function(){var self = TMP_4.$$s || this, TMP_5;

          return $send(self, 'o', ["tr"], (TMP_5 = function(){var self = TMP_5.$$s || this, TMP_6, TMP_7, TMP_8;

            
              $send(self, 'o', ["td#box1", $hash2(["class"], {"class": self.$state().$bg()})], (TMP_6 = function(){var self = TMP_6.$$s || this;

              return "Box 1"}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6));
              $send(self, 'o', ["td#box2", $hash2(["class"], {"class": self.$state().$bg()})], (TMP_7 = function(){var self = TMP_7.$$s || this;

              return "Box 2"}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7));
              return $send(self, 'o', ["td#box3", $hash2(["class"], {"class": self.$state().$bg()})], (TMP_8 = function(){var self = TMP_8.$$s || this;

              return "Box 3"}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8));}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5))}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4));
          return $send(self, 'o', ["table", $hash2(["style"], {"style": $hash2(["paddingTop"], {"paddingTop": "30px"})})], (TMP_9 = function(){var self = TMP_9.$$s || this, TMP_10, TMP_13, TMP_16;

          
            $send(self, 'o', ["tr"], (TMP_10 = function(){var self = TMP_10.$$s || this, TMP_11, TMP_12;

            return $send(self, 'o', ["button.redBtn", $hash2(["onclick"], {"onclick": $send(self, 'lambda', [], (TMP_11 = function(){var self = TMP_11.$$s || this;

              return self.$actions().$set_bg($hash2(["value"], {"value": "red"}))}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11))})], (TMP_12 = function(){var self = TMP_12.$$s || this;

              return "Red"}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12))}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10));
            $send(self, 'o', ["tr"], (TMP_13 = function(){var self = TMP_13.$$s || this, TMP_14, TMP_15;

            return $send(self, 'o', ["button.blueBtn", $hash2(["onclick"], {"onclick": $send(self, 'lambda', [], (TMP_14 = function(){var self = TMP_14.$$s || this;

              return self.$actions().$set_bg($hash2(["value"], {"value": "blue"}))}, TMP_14.$$s = self, TMP_14.$$arity = 0, TMP_14))})], (TMP_15 = function(){var self = TMP_15.$$s || this;

              return "Blue"}, TMP_15.$$s = self, TMP_15.$$arity = 0, TMP_15))}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13));
            return $send(self, 'o', ["tr"], (TMP_16 = function(){var self = TMP_16.$$s || this, TMP_17, TMP_18;

            return $send(self, 'o', ["button.greenBtn", $hash2(["onclick"], {"onclick": $send(self, 'lambda', [], (TMP_17 = function(){var self = TMP_17.$$s || this;

              return self.$actions().$set_bg($hash2(["value"], {"value": "green"}))}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17))})], (TMP_18 = function(){var self = TMP_18.$$s || this;

              return "Green"}, TMP_18.$$s = self, TMP_18.$$arity = 0, TMP_18))}, TMP_16.$$s = self, TMP_16.$$arity = 0, TMP_16));}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9));}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2))
      }, TMP_MainComponent_render_19.$$arity = 0), nil) && 'render'
